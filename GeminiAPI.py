...
personal_info = ("My name is Kush Patel. I am a computer science major studying at Bridgewater State University (BSU),"
                 ...
                 "I was awarded Dr. Linda Wilkens and Dr. Glenn Pavlicek Scholarship at BSU in recognition of my academic achievements such"
                 " as a 4.0 major GPA. I am from East Greenwich, Road Island but I currently live in Fairhaven, Massachusetts. Some programing "
                 "languages that I am proficient at are Python, Java, Swift, and JavaScript. I also MySQL from my database system course. Currently, "
                 "I am developing a bank statement processing application that efficiently converts bank statements into Excel spreadsheets. With a "
                 "positive attitude and a relentless motivation to learn, I'm eager to take on new challenges and expand my expertise. Additionally, "
                 "along with my current project, I am also doing a research internship at Bridgewater State University in which I am developing a program "
                 "that can recognize a table in an image and convert it to an excel table. Some tools that I know are Git, JetBrain IDEs, Xcode, and Vscode. "
                 "My hobbies are playing basketball, cricket, and programing.")
